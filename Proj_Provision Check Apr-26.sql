...
select a.Company, a.Sku, a.Description,	a.Dept2,	a.Department,	a.Subdepartment,	a.Class,	a.Subclass, a.Brand, a.ABCFlag, a.PopGradeNo, a.StoreType,
    a.Stockbracketdescription, a.Stockbracket,					
	sum(a.total_stk_qty) QtyOH, sum(a.total_stk$)	Stock, sum(a.Total_Prov$) Provision,			
    case					
        when Dept2 = 'Lifestyle' and brand <> 'STANL' then '1 - LIFESTYLE Categories'	
        when Dept2 = 'Lifestyle' and brand = 'STANL' then '1 - LIFESTYLE Stanley'	
        ...
        when StoreType in ('Demo','Defective') then '5 - Demo/Defect'
        else Department
        end as 'Category'					
into #DataExtract					
...
group by a.Company, a.Sku, a.Description,	a.Dept2,	a.Department,	a.Subdepartment,	a.Class,	a.Subclass,  a.Brand, a.ABCFlag, a.PopGradeNo, a.StoreType,
    a.stockbracketdescription, a.stockbracket					
--having sum(a.total_stk_qty) <>0 and sum(a.total_stk$) <> 0;					
	
 
Select Brand,
    SUM(stock) Stock, SUM(provision) Provision
from #DataExtract	
where Category = '1 - LIFESTYLE Categories'
group by Brand

/*
Select Company, Category, stockbracket, 
    SUM(stock) Stock, SUM(provision) Provision
from #DataExtract	
group by Company, Category, stockbracket
*/
